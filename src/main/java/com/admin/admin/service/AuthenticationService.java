...
public class AuthenticationService {
    ...
    public ResponseEntity<?> register(RegisterRequest registerRequest){
        try {
            ...
            helper.setSubject("Validate Account WanderShare");
            helper.setText("""
                        <div>
                          <a href="http://localhost:8080/api/v1/auth/valicate-email?email=%s&otp=%s" target="_blank">Click to VERIFY ACCOUNT and go to LOGIN NOW</a>
